...
const TRANSLATIONS = {
  en: {
    ...
    adminClose: "Close",
    adminApiKeyLabel: "API key (only if the server requires one)",
  ...
  az: {
    ...
    adminClose: "Bağla",
    adminApiKeyLabel: "API açarı (yalnız server tələb etdikdə)",
  ...
  tr: {
    ...
    adminClose: "Kapat",
    adminApiKeyLabel: "API anahtarı (yalnızca sunucu gerektiriyorsa)",
  ...
  ru: {
    ...
    adminClose: "Закрыть",
    adminApiKeyLabel: "API-ключ (только если сервер его требует)",
